...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2023-04-12T21:01:45.581071" />
  ...
  <link href="/media/css/fontawesome.css?19682de8" rel="stylesheet">
  <link rel="stylesheet" href="/media/css/bootstrap-4.4.1.min.css">
  <link rel="shortcut icon" href="/favicon.ico" />
  
  <link rel="stylesheet" type="text/css" href="/dyncss/base.css?19682de8">

  <script src="/media/js/theme.js?19682de8"></script>
      ...
      <div class="text">
        <ul>
            ...
            <li class=" non-badged">
              ...
              2023-06-06 &middot; <a href="/about/event/postgres-vision-london-2023-2460/">Postgres Vision London 2023</a>
            </li>
    ...
    <div class="col-lg-5">
      <div class="sidebar">
        ...
        <ul class="divided">
            ...
            <li>
              <h3><a href="/about/news/credcheck-v10-released-2619/">credcheck v1.0 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2023-04-06 by MigOps</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/announcing-the-e-maj-420-release-2618/">Announcing the E-Maj 4.2.0 release.</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2023-04-03 by Philippe Beaudoin</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pg_dumpbinary-v210-released-2617/">pg_dumpbinary v2.10 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2023-03-30 by Gilles Darold</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/influxdb-fdw-200-released-2616/">InfluxDB FDW 2.0.0 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2023-03-28 by Toshiba</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pg_chameleon-2019-2615/">pg_chameleon 2.0.19</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2023-03-28 by Federico Campoli</li>
              </ul>
            </li>
...
<!-- Blog -->
     ...
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5Jb"> Fun with PostgreSQL puzzles: Finding shortest paths and travel costs with funct</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Greg Sabino Mullane</li>
              <li><i class="far fa-clock"></i>&nbsp;2023-04-12</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5Ja"> Split-Brain in PostgreSQL Clusters – Causes, Prevention, and Resolution</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5J9"> How collation of punctuation and whitespace works</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5J8"> Parallel aggregate – PostgreSQL 16 – better performance</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Pavlo Golub</li>
              <li><i class="far fa-clock"></i>&nbsp;2023-04-11</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5J7"> How much does it take to compile PostgreSQL (on my machines)?</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5J6"> PostgreSQL Schema: Learning PostgreSQL with Grant</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Grant Fritchey</li>
              <li><i class="far fa-clock"></i>&nbsp;2023-04-10</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5J5"> Setting Up PostgreSQL Failover and Failback, the Right Way!</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5J3"> PGSQL Phriday #007 – Triggers for tracking changes in a table</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5J2"> Updating the Cost Limit On The Fly</a></h3>
            <ul class="meta">
 ...
 <!-- END SUBMIT A BUG -->
    ...
    <script src="/media/js/main.js?19682de8"></script>
